  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Analytics Dashboard</h1>
          <p className="text-gray-300">Track your content performance across all platforms</p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">{formatNumber(summary?.total_views || 0)}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">{formatNumber(summary?.total_engagement || 0)}</p>
              </div>
        ...
        <CardContent>
          <div className="space-y-4">
            {summary?.top_performing_posts.slice(0, 5).map((post, index) => {
              ...
              return (
                <div key={post.id} className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg">
                  <div className="flex-1">
                    ...
                    <h3 className="text-white font-medium mt-2 truncate">{post.title}</h3>
                  ...
                  <div className="flex items-center space-x-6 text-sm">
                    ...
                    <div className="text-center">
                      <p className="text-white font-medium">{formatNumber(engagement)}</p>
                      <p className="text-gray-400">Engagement</p>
                    </div>
                    <div className="text-center">
                      <p className="text-white font-medium">{getEngagementRate(post)}%</p>
            ...
            {(!summary?.top_performing_posts || summary.top_performing_posts.length === 0) && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 text-sm">Analytics will appear here once content is published</p>
              </div>
            )}
          </div>
        </CardContent>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700">
                  ...
                  <th className="text-center py-3 px-4 text-gray-300">Views</th>
                  <th className="text-center py-3 px-4 text-gray-300">Engagement</th>
                  <th className="text-center py-3 px-4 text-gray-300">Rate</th>
                </tr>
              </thead>
              <tbody>
            ...
            {recentPosts.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400">No posts found for this time period</p>
              </div>
            )}
          </div>
        </CardContent>
