...
export const NotificationCenter = () => {
  ...
  const loadNotifications = async () => {
    ...
    try {
      ...
      // Type cast and filter valid notification types
  ...
  return (
    <Card className="absolute top-12 right-0 w-96 max-h-96 overflow-hidden bg-slate-800/95 border-slate-700 backdrop-blur-sm z-50">
